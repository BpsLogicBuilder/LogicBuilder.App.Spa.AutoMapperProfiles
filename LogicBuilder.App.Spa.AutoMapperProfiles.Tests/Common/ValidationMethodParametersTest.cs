...
namespace LogicBuilder.App.Spa.AutoMapperProfiles.Tests.Common
{
    ...
    {
        static ValidationMethodParametersTest()
        {
            Initialize();
        }
        ...
        public void Constructor_WithParameters_SetsPropertiesCorrectly()
        {
            ...
            //ACt
            var descriptor = mapper.Map<ValidationMethodDescriptor>(parameters);

            // Assert
            Assert.Equal("required", descriptor.Method);
            Assert.Equal("This field is required", descriptor.Message);
        }
