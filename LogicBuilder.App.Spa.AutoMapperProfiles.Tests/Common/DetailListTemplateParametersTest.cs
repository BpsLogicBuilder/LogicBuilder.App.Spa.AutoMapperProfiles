...
namespace LogicBuilder.App.Spa.AutoMapperProfiles.Tests.Common
{
    ...
    {
        static DetailListTemplateParametersTest()
        {
            Initialize();
        }
        ...
        public void Constructor_WithTemplateName_SetsPropertyCorrectly()
        {
            ...
            //ACt
            var descriptor = mapper.Map<DetailListTemplateDescriptor>(parameters);

            // Assert
            Assert.Equal("listTemplate", descriptor.TemplateName);
        }
