...
namespace LogicBuilder.App.Spa.AutoMapperProfiles.Tests.Common
{
    ...
    {
        static DetailFieldTemplateParametersTest()
        {
            Initialize();
        }
        ...
        public void Constructor_WithTemplateName_SetsPropertyCorrectly()
        {
            ...
            //ACt
            var descriptor = mapper.Map<DetailFieldTemplateDescriptor>(parameters);

            // Assert
            Assert.Equal("detailTemplate", descriptor.TemplateName);
        }
