...
namespace LogicBuilder.App.Spa.AutoMapperProfiles.Tests.Common
{
    ...
    {
        static TextFieldTemplateParametersTest()
        {
            Initialize();
        }
        ...
        public void Constructor_WithTemplateName_SetsPropertyCorrectly()
        {
            ...
            //ACt
            var descriptor = mapper.Map<TextFieldTemplateDescriptor>(parameters);

            // Assert
            Assert.Equal("textTemplate", descriptor.TemplateName);
        }
