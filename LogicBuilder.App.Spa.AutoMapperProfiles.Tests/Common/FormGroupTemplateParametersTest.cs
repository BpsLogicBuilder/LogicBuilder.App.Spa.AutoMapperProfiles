...
namespace LogicBuilder.App.Spa.AutoMapperProfiles.Tests.Common
{
    ...
    {
        static FormGroupTemplateParametersTest()
        {
            Initialize();
        }
        ...
        public void Constructor_WithTemplateName_SetsPropertyCorrectly()
        {
            ...
            //ACt
            var descriptor = mapper.Map<FormGroupTemplateDescriptor>(parameters);

            // Assert
            Assert.Equal("formGroupTemplate", descriptor.TemplateName);
        }
